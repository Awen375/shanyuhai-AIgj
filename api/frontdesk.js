            ...
            for (const key of chatKeys) {
                ...
                if (data) {
                    try {
                        ...
                        if (msg.room === room) {
                            messages.push({
                                sender: msg.sender || (msg.question ? 'guest' : 'ai'),
                                text: msg.reply || msg.question || msg.text,
                                time: msg.time
                            });
                        }
                    } catch (e) {}
